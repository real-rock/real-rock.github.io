...
## Product Purpose
Jin이 일하고 공부하면서 배운 것을 기록하는 개인 블로그다. 지금 중심 콘텐츠는 PostgreSQL과 MongoDB 인터널 연재로, 내부 동작과 그 구조가 실제 운영에서 어떤 현상으로 나타나는지를 설명한다. 연재는 독자가 처음부터 순서대로 읽으며 개념을 쌓아 올릴 수 있으면 성공이다.
